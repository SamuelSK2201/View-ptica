...
if($perm_relatorios != 1 && $perm_relatorios_reagendar != 1)
    die("Acesso negado!");
...
if($_GET['cmd'] == "del")
{
    ...
    redireciona("r_agendar.php?ind_msg=1");
}
...
$title = "'View Óptica<br>Reagendar'";
$columns = '0, 1, 2, 3, 4';
$order = ',order: [[ 4, "desc" ]]';
?>
...
<div class="wrapper wrapper-content animated fadeInRight">  
    <?
    $str = "SELECT * FROM prospeccao WHERE idempresa = '$adm_empresa' AND status = '7' $strWherePesq ORDER BY data";
    $rs  = mysqli_query($conexao, $str) or die(mysqli_error($conexao));
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Lista de pesquisas marcadas como REAGENDAR</h5>
                </div>
                        ...
                        <table id="list" class="table table-striped table-bordered table-hover dataTables-example" style="font-size: 10px;" >
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><div class="status_<?=$codigo?>"><span class="label label-warning">Reagendar</span></div></td>
                                    <td class="center">
                                    ...
                                    <td class="center">
                                        ...
                                        <a class="btn btn-danger btn-circle" type="button" title="excluir" href="r_reagendar.php?cmd=del&codigo=<?=$vet['codigo']?>" onclick="javascript: if(!confirm('Deseja realmente excluir este registro?')) { return false }"><i class="fa fa-trash-o"></i></a> 
                                    </td>
                                </tr>
                                <?
                                }
    ...
    <div class="row">
        <div class="col-lg-12">
            <p class="font-bold  alert alert-danger m-b-sm">
                Nenhuma pesquisa maracada como REAGENDAR no sistema.
            </p>
        </div>
    </div>
    <?

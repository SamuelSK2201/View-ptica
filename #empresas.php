...
{   
    ...
    $str = "INSERT INTO empresas (pessoa, nome, cpf, razao_social, nome_fantasia, cnpj, contato, cargo, telefone, email, num_usuarios, ind_pesquisa, ind_atendimento, txt_rodape, str_format, data_cadastro) 
        VALUES ('$pessoa', '$nome', '$cpf', '$razao_social', '$nome_fantasia', '$cnpj', '$contato', '$cargo', '$telefone', '$email', '$num_usuarios', '$ind_pesquisa', '$ind_atendimento', '$txt_rodape', '$str_format', '$data_cadastro')";

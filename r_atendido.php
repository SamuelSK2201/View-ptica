...
if($perm_relatorios != 1 && $perm_relatorios_atendido != 1)
    die("Acesso negado!");
...
if($_GET['cmd'] == "del")
{
    ...
    redireciona("r_atendido.php?ind_msg=1");
}
...
<div class="wrapper wrapper-content animated fadeInRight">  
    <?
    $str = "SELECT * FROM prospeccao WHERE idempresa = '$adm_empresa' AND status = '8' $strWherePesq ORDER BY data";
    $rs  = mysqli_query($conexao, $str) or die(mysqli_error($conexao));
        ...
        <div class="col-lg-12">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Lista de pesquisas marcadas como ATENDIDO</h5>
                </div>
                        ...
                        <table id="list" class="table table-striped table-bordered table-hover dataTables-example" style="font-size: 10px;" >
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><div class="status_<?=$codigo?>"><span class="label label-default" style="background-color: #9F81F7; color:#fff">Atendido</span></div></td>
                                    <td class="center">
                                    ...
                                    <td class="center">
                                        <a class="btn btn-warning btn-circle" type="button" title="editar / visualizar" href="prospeccao.php?ind=2&codigo=<?=$vet['codigo']?>&url=<?=base64_encode('r_atendido.php')?>"><i class="fa fa-edit"></i></a>
                                        <a class="btn btn-danger btn-circle" type="button" title="excluir" href="r_atendido.php?cmd=del&codigo=<?=$vet['codigo']?>" onclick="javascript: if(!confirm('Deseja realmente excluir este registro?')) { return false }"><i class="fa fa-trash-o"></i></a> 
                                    </td>
                                </tr>
                                <?
                                }
    ...
    <div class="row">
        <div class="col-lg-12">
            <p class="font-bold  alert alert-danger m-b-sm">
                Nenhuma pesquisa maracada como ATENDIDO no sistema.
            </p>
        </div>
    </div>
    <?
